...
namespace ThePhotoShop5.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var invoices = db.Invoices.Include(i => i.Client).Include(i => i.Reservation);
        ...
        public ActionResult Create([Bind(Include = "InvoiceId,ClientId,ReservationId,AmountDue,InvoicePaid")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InvoiceId,ClientId,ReservationId,AmountDue,InvoicePaid")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
